...
PLATFORMS = {
    ...
    "shortmax": {
        ...
        "company": "ShortMax",
        "description_zh": "海外短剧平台 (纯SPA，暂无公开API)",
        "description_en": "Short drama platform (SPA, no public API yet)",
        "status": "no_api",
    },
    "flextv": {
        "name_zh": "FlexTV",
    ...
    "topshort": {
        ...
        "company": "TopShort",
        "description_zh": "海外短剧平台 (仅下载页，无数据)",
        "description_en": "Short drama platform (landing page only, no data)",
        "status": "no_api",
    },
    "hongguo": {
        "name_zh": "红果短剧",
        ...
        "description_zh": "国内最大短剧平台，需中国大陆网络+认证",
        "description_en": "Largest CN short drama platform, requires China access + auth",
